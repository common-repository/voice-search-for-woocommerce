...
Tags:              voice search, wooCommerce, iOS voice search, Microsoft Edge voice search, multi platform voice search, voice, AI, speech, FireFox voice search, api, elementor, page builder
...
Add an universal, multi lingual voice search to wooCommerce web pages. This plugin will add voice search ability to all wooCommerce web pages. Simply click the microphone and dictate your search terms. 
The plugin will automatically detect end of speech and submit your search to the wooCommerce store.

Add voice search to your WooCommerce store. This simple, fast, and intuitive plugin helps your shoppers find what they're looking for with the ultimate in accessibility - their voice. Our plugin supports 130 languages and follows stringest ethical and privacy guidelines to protect your shoppers privacy while delivering the highest levels of security to your store.
...
[The Pro version available on our website](https://speak2web.com/voice-shopping-for-woocommerce-v2/) adds support for all modern browsers and platforms as well as our full set of language models. Visit our website for current Pro rates, customization services, and to obtain a license key to unlock the full suite of services this amazing plugin has to offer.
...
We post data to Amazon Web Services for storing user databases.
[speak2web APIs license activation and acces key generation:] (https://xxxxx.execute-api.us-east-1.amazonaws.com/V2)
...
++++++++++++++++++++++++++
speak2web is utilizing the following Google API Services as part of this plugin:
[Google STT:] (https://speech.googleapis.com/v1/speech:recognize) 

[The Terms of Google Cloud Services] (https://cloud.google.com/terms/)  
[Google Cloud Service Privacy Statement] (https://cloud.google.com/terms/cloud-privacy-notice) 
...
3. Either search for the "Voice search for WooCommerce" plugin on the wordpress.org plugin store or upload the ZIP file obtained from https://speak2web.com
4. Activate the plugin
Optional install license key to support all browsers and platforms
1. Navigate to "Settings/Voice Search for WooCommerce" on right hand navigation bar
...
You can visit [our website](https://speak2web.com/voice-shopping-for-woocommerce-v2/) and select the Pro upgrade for Voice Search for WooCommerce.
...
You can see more details at the speak2web web page [Plugin Details](https://speak2web.com/voice-shopping-for-woocommerce-v2/)
...
- On loading of the plugin on a page -
Every time the plugin is loaded onto a page, a call is issued to the a speak2web service (hosted in AWS - AWS - API call to spea2web service) to retrieve a valid token to access IBM cloud services
...
Elementor:
++++++++++++++++++++++++++++++++++++++++++
Steps to enable Elementor on voice-seatch-for-woocommerce plugin-

1. In admin page of your website on the left navigation bar-
	Plugins -> Add New  and search and install "Elementor Website Builder"

2. Head over to Plugins -> Installed Plugins and activate both the "Elementor Website Builder" and  "Voice Search For WooCommerce".

3. Head over to "Voice Search For WooCommerce" -> Settings and check mark "Enable Elementor" settings. 
	(Note - Currently Elementor works conditionally with our flaoting mic widget, if single click is enabled, elementor wont work. This can be changed as per requirements)

4. Now Elementor is active! Go to any page and select option "Edit with Elementor" option. It will open up a widget toolbox on the left side.

5. Search for "Floating Mic Widget" and place it anywhere on the webpage! User can currently customise its color and icon.
...
= 1.0.1 =
* Bug fix, played extra voice response that wasn't needed
...
* Upgraded to PHP 8.0
* Upgraded to WooCommerce 7.4.1

= 2.1.0 =
* Added Improved Microphone 
* Added hot key operation
* Improved audio file handling 
* Upgraded to Wordpress 6.2.2
* Upgraded to WooCommerce 7.8.2
